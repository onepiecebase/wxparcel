...
export default class Transformer {
  ...
  constructor(params: Typings.ParseParams, options?: OptionManager) {
   ...
   * 解析
   */
  public async transform (): Promise<Typings.ParseResult> {
   ...
   * @returns 匹配到的别名集合
   */
  public matchAlias (pattern: string, alias: Typings.ParseAlias): string[] {
   ...
   * @returns 文件路径 (匹配不到返回 undefined)
   */
  public async findFileByAlias (filename: string, alias: Typings.ParseAlias): Promise<string> {
    return new Promise((resolve, reject) => {
